...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>员工名:</label><input id="search-name" class="wu-text" style="width:100px">
            <label>所属角色:</label>
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td valign="middle">
                	<img id="preview-photo" style="float:left;" src="/Cyclamen/resources/admin/easyui/images/user_photo.jpg" width="100px">
            ...
            <tr>
                ...
                <td><input type="text" id="add-photo" name="photo" value="/Cyclamen/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
                <td width="60" align="right">员工名:</td>
                <td><input type="text" name="username" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写员工名'" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="phoneNum" class="wu-text easyui-validatebox" /></td>
            </tr>
        </table>
    </form>
</div>
	...
	<form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td width="60" align="right">头像预览:</td>
                <td valign="middle">
                	<img id="edit-preview-photo" style="float:left;" src="/Cyclamen/resources/admin/easyui/images/user_photo.jpg" width="100px">
                	<a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">头像:</td>
                <td><input type="text" id="edit-photo" name="photo" value="/Cyclamen/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
                <td width="60" align="right">员工名:</td>
                <td><input type="text" id="edit-username" name="username" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写员工名'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">所属角色:</td>
                <td>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'photo',title:'员工头像',width:100,align:'center',formatter:function(value,row,index){
				var img = '<img src="'+value+'" width="50px" />';
				return img;
			}},
			{ field:'username',title:'员工名',width:100,sortable:true},
			...
			{ field:'phoneNum',title:'联系方式',width:200}
		]],
