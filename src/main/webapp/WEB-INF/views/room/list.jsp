	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td width="60" align="right">图片预览:</td>
                <td valign="middle">
                	<img id="edit-preview-photo" style="float:left;" src="/Cyclamen/resources/upload/1547560664869.jpg" width="100px">
                	<a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">房间图片:</td>
                <td><input type="text" id="edit-photo" name="photo" value="/Cyclamen/resources/upload/1547560664869.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
           <tr>
                <td align="right">房间编号:</td>
