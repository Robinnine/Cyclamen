...
<%@ page import="cn.cl.cyclamen.backup.Command" %>
<%
...
<head lang="en">
    ...
    <meta name="Keywords" content="仙客来民宿网站">
...
<div id="contain">
    ...
    <div class="content">
        ...
        <div class="order" style="display: block;margin: 0 auto;">
            <table style="margin: 0 auto;">
                ...
                <c:forEach items="${bookOrderList }" var="bookOrder">
                    ...
                    <tr>
                       ...
                       <%-- --%><td>
                            <c:if test="${bookOrder.status == 3}">
                                <a class="btn btn-primary" href="#" onclick="window.location.href='../room'">重新预定</a>
                                <!--<input type="button" class="disable" value="重新预定">-->
                            </c:if>
                            <c:if test="${bookOrder.status == 0 }">
                                <!-- <button type="button" id="cancel-info-btn" class="btn btn-success" style="width:100px;text-align: center;" >取消订单
                                </button>-->
                                <input id="status" type="button" value="取消订单" class="btn btn-success" style="width:100px;text-align: center;"
            ...
            <form id="update-info-form">
                <table style="border:0px;cellspacing:0px;">
                    ...
                    <tr style="margin-top: 5px">
                        <td style="border:0px;margin-top: 5px">用户名：</td>
                        <td style="width:200px;max-width: 420px;border:0px;margin-top: 5px"><input class="form-control"
                                                                                                   type="text"
                                                                                                   value="${user.name}"
                                                                                                   name="name"/></td>
                    </tr>
                    <tr style="border:0px; ">
                        <td style="border:0px;margin-top: 5px">真实姓名：</td>
                        <td style="float:left;width:200px;max-width: 820px;border:0px;margin-top: 5px;"><input
                                class="form-control"
                                type="text"
                                value="${user.realName}"
                                name="realName"/></td>
                    ...
                    <tr>
                        <td style="border:0px;margin-top: 5px">身份证号：</td>
                        <td style="float:left;width:200px;max-width: 820px;border:0px;margin-top: 5px"><input
                                class="form-control"
                                type="text"
                                value="${user.idCard}"
                    ...
                    <tr>
                        <td style="border:0px;margin-top: 5px">手机号码：</td>
                        <td style="float:left;width:200px;max-width: 820px;border:0px;margin-top: 5px"><input
                                class="form-control"
                                type="text"
                                value="${user.mobile}"
                    ...
                    <tr>
                        <td style="float:left;margin-top:15px;width:400px;max-width: 820px;border:0px;padding-left: 500px;margin-top: 50px;">
                            <button type="button" id="update-info-btn" class="btn btn-success"
        ...
        <div class="pwd">
            <table style="border:0px;cellspacing:0px;">
                <tbody>
                <tr>
                    <td style="border:0px;margin-top: 5px">原密码：</td>
                    <td style="float:left;width:400px;max-width: 420px;border:0px;margin-top: 5px"><input
                            class="form-control"
                            type="password"
                            id="old-password"/></td>
                </tr>
                <tr style="border:0px;">
                    <td style="border:0px;margin-top: 5px">新密码：</td>
                    <td style="float:left;width:400px;max-width: 820px;border:0px;margin-top: 5px"><input
                            class="form-control"
                            type="password"
                            id="new-password"/></td>
                </tr>
                <tr>
                    <td style="border:0px;margin-top: 5px">重复密码：</td>
                    <td style="float:left;width:400px;max-width: 820px;border:0px;margin-top: 5px"><input
                            class="form-control"
                            type="password"
                            id="renew-password"/></td>
                </tr>
...
<script>
    ...
    function display_alert() {
        if (window.confirm("确定要取消订单吗？")){
            alert("暂时只可电话取消订单哦！联系方式：1234335676");
        }
        else
        {
           return;
